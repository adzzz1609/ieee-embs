 ...
 const boardMembers = [
      {
        name: "Ishita Mohanta",
        role: "Chairperson",
        image: "/assets/ishita-mohanta-no-lettering.png",
        about: "Smart, kind, and full of energy, Ishita is someone who truly lights up the room. Always open to conversations and new connections, she makes everyone feel heard and welcome.\nHer dedication, hard work, and passion for IEEE EMBS shows in everything she does.\nHumble, thoughtful, and endlessly bubbly, she leads with both heart and purpose.",
      },
      {
        name: "Bhadra Sanjay Namboodiry",
        role: "Vice-Chairperson",
        image: "/assets/bhadra-sanjay-namboodiry-no-lettering.png",
        about: "With her clear and focused mind, she is ready to lead the chapter to even newer heights.\n\nWhile she posseses a calm demeanor, she is also quietly observant. When push comes to shove, she knows how to get everyone and everything back on track.",
      },
      {
        name: "Tanisha Choudhuri",
        role: "Secretary",
        image: "/assets/tanisha-chaudhari-no-lettering.png",
        about: "A leader who takes charge of maintaining the chapter while bringing fun, energy, and personality along the way.\n\nIntelligent, graceful, with a pinch of sass, our Secretary is the perfect fit to lead, inspire, and evolve our chapter into something even greater.",
      },
      {
        name: "S Hashmitha",
        role: "Co-Secretary",
        image: "/assets/hashmita-no-lettering.png",
        about: "Our adorable/extremely kind/patient/always-there-for-everyone and amiable ball of sunshine! If you need a lending hand or if you're feeling left out in a group, she'll be the first one to instantly make you feel welcomed. You can trust her to make sure things run smoothly no matter how hectic it could get.",
      },
      {
        name: "A Nethraa",
        role: "Finance Head",
        image: "/assets/nethraa-no-lettering.png",
        about: "Numbers and strategy, she runs the show,\nTraditional Tamil grace in the flow.\nFinance head with unmatched flair,\nFocused on accounts, phone? Barely there.",
      },
      {
        name: "P Daphne Christina Ruby",
        role: "Research Head",
        image: "/assets/daphne-no-lettering.png",
        about: "Collaborative, free spirited and full of quiet confidence. The driving force behind our technical prowess and expertise in biomedical science. She is dedicated to spearheading innovative projects and exploring new avenues.",
      },
      {
        name: "Prithiksha Suresh Kumar",
        role: "Design Head",
        image: "/assets/pritiksha-no-lettering.png",
        about: "Fun at heart, sharp in vision. A beautiful blend of creativity with discipline. She might be easy to work with, however, she is uncompromising when it comes to quality. A mentor who pushes you to do better and design smarter.",
      },
      {
        name: "Haripriya Muni",
        role: "Public Relations Head",
        image: "/assets/haripriya-no-lettering.png",
        about: "Jovial, fun-loving, and always ready to strike up a conversation, she's basically a people magnet. When it comes to ideas, her brain runs like a full-speed fire engine, constantly beaming with creative sparks. Super friendly, always helpful when you need her, and incredibly approachable, she puts in her best effort to make sure our events reach everyone, effortlessly turning ideas into buzz wherever she goes.",
      },
      {
        name: "Aryabrata Pattnaik",
        role: "Editorial Head",
        image: "/assets/aryabrata-no-lettering.png",
        about: "A powerhouse of ideas, curiosity, and creative chaos. Always active and full of unexpected thoughts, he turns ideas into engaging blogs and articles, making him the most suitable person for this role.",
      },
      {
        name: "Pooja Priyadarshini",
        role: "HR Head",
        image: "/assets/pooja-no-lettering.png",
        about: "Soft-spoken, sharp-minded... and suddenly very loud about F1.\nSweet, smart, and a perfectionist at heart.\nBrains, beauty, and speed talk combined.",
      },
    ];

    function IEEEEMBSLogo({ className, style }) {
      return (
        <img 
          src="/assets/embs-logo-transparent.png" 
          alt="IEEE EMBS Logo"
          className={className}
      ...
      return (
        ...
        >
          {image ? (
            ...
            <span className="font-mono text-sm" style={{ color: "#45bed6" }}>{initials}</span>
          )}
        </div>
      );
    }

    function LiquidMetalIDCard({ name = "Name", role = "Role", image, about = "A dedicated member of the IEEE EMBS board." }) {
          ...
          >
            ...
            >
              ...
              <div
                className="absolute inset-0"
                style={{
                  background: "linear-gradient(135deg, #020404 0%, #06171c 28%, #050506 52%, #190817 74%, #020404 100%)",
                }}
              />
              ...
              <motion.div className="absolute inset-0 overflow-hidden rounded-2xl">
                <motion.div
                  ...
                  style={{
                    background: "linear-gradient(90deg, transparent 0%, transparent 40%, rgba(69,190,214,0.16) 48%, rgba(216,88,151,0.12) 54%, transparent 62%, transparent 100%)",
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: "inset 0 1px 1px rgba(69,190,214,0.22), inset 0 -1px 1px rgba(216,88,151,0.16), 0 18px 46px rgba(216,88,151,0.12)",
                }}
              />

              <div className="relative h-full p-8 flex flex-col justify-between gap-5" style={{ transform: "translateZ(30px)" }}>
                <div className="grid items-center gap-6" style={{ gridTemplateColumns: "112px minmax(0, 1fr)", minHeight: "150px" }}>
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <span className="uppercase" style={{ color: "#45bed6", fontSize: "9px", fontFamily: "monospace", letterSpacing: "0.1em" }}>
                  Click to flip
                </span>
              </motion.div>
              </motion.div>
              ...
              <div
                className="absolute inset-0"
                style={{
                  background: "linear-gradient(225deg, #06171c 0%, #120713 34%, #020404 62%, #0b1d22 100%)",
                }}
              />
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: "inset 0 1px 1px rgba(216,88,151,0.2), inset 0 -1px 1px rgba(69,190,214,0.16)",
                }}
              />
              ...
              <div className="relative h-full p-8 flex flex-col justify-between">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="uppercase" style={{ color: "#d85897", fontSize: "11px", fontFamily: "monospace", letterSpacing: "0.22em" }}>
                    IEEE EMBS BOARD
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="uppercase" style={{ color: "#45bed6", fontSize: "10px", fontFamily: "monospace", letterSpacing: "0.2em" }}>
                      About
                    </h3>
                    <p
                ...
                <motion.div
                  ...
                  animate={{ opacity: 0.5 }}
                >
                  <span className="uppercase" style={{ color: "#d85897", fontSize: "9px", fontFamily: "monospace", letterSpacing: "0.1em" }}>
                    Click to flip back
                  </span>
                </motion.div>
              </div>
      ...
      <div className="relative z-10 text-center mb-16">
        ...
        <p
          ...
          style={{
            letterSpacing: "0.3em",
            background:
              "linear-gradient(90deg, #45bed6 0%, #f0c4da 45%, #d85897 100%)",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent",
          }}
        >
